...
if p == 0 && q == 0
    ...
    b1 = clifford(['e' index_characters([1:p, p+2:p+1+q])]);
end
b2 = clifford(['e' index_characters(1:p+1+q)]);
b3 = clifford(['e' index_characters(p+1)]);
b4 = clifford(['e' index_characters([1:p p+2:p+1+q+1])]);
b5 = clifford(['e' index_characters(p+1+q+1)]);
b6 = b3 .* b5;
...
% $Id: isom1m1.m 271 2021-07-11 19:54:47Z sangwine $
