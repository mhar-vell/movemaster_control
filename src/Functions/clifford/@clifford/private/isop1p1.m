...
M11 = subsref(M, substruct('()', {  1:J,   1:K})); %#ok<*BDSCI> % TODO This will fail if
...
b2 = clifford(['e' index_characters(p+1)]);
b3 = clifford(['e' index_characters(p+1+q+1)]);
b4 = clifford(['e' index_characters([p+1 p+1+q+1])]);
...
% $Id: isop1p1.m 271 2021-07-11 19:54:47Z sangwine $
