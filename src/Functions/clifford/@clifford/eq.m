...
if cl && cr
    ...
    % TODO If b becomes false anywhere here, the two multivectors cannot be
    ...
    % in between loops, rather than inside the loops?
...
% $Id: eq.m 271 2021-07-11 19:54:47Z sangwine $
