...
if isempty(m)
    if all(d == 0) && length(d) == 2
        % Default case, where the size is [0, 0] and we don't output this
...
elseif ismatrix(m) && d(1) == 1 && d(2) == 1
    ...
    % disp(S)
    flag = false; % TODO What is this flag for? It doesn't seem to be used?
...
% $Id: disp.m 271 2021-07-11 19:54:47Z sangwine $
