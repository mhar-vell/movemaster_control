...
% form (e.g. e1, e123). The table applies for the current algebra
% initialised with clifford_signature.

% Copyright © 2011, 2012, 2014, 2015, 2021
...
for I = 1:m % These are index values into the multiplication table, which
    ...
    for J = 1:m
        ...
        % First deal with the sign. We compute the sign dynamically, even
        % if the sign table exists in the descriptor, for simplicity, and
        % because speed is not important here.
...
% $Id: clifford_multiplication_table.m 270 2021-07-11 19:42:06Z sangwine $
