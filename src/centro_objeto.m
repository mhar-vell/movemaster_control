...
%clc;
clearvars xg yg ag bg cg s s_1 s_2 s_3 s_4 s_5 s_6 s_7 s_8 s_9;
clearvars sn sn_1 sn_2 sn_3 sn_4 sn_5 sn_6 sn_7 sn_8 sn_9;
clearvars mg1 mg mov ms ms1 ms2 mt;
...
while (objeto == 0)
    ...
    if ((zm_s1>sn(1) || zm_s4>sn(4) || zm_s7>sn(7)) && mov==0)
        mov = 1;
        xg=0;
        %objeto = 1;
        for k=1:1:9
            ms1(k,:) = [sn(k) xg yg msg.Set1];
        end
    end
    pause(1);
    %while ((mov == 1) && ((zm_s1>sn(1)  && zm_s7>sn(7)) || (zm_s3>sn(3) && zm_s6>sn(6) && zm_s9>sn(9))))
    while ((mov == 1) && ((zm_s1>sn(1) || zm_s4>sn(4) || zm_s7>sn(7)) || (zm_s3>sn(3) || zm_s6>sn(6) || zm_s9>sn(9))))    
        ...
        for l=1:1:9
            mg1=bg+l;
            mg = bg +l;
            ms1(mg1,:) = [sn(l) xg yg msg.Set1];
            mt(mg,:) = [sn(l) xg yg msg.Set1];
    ...
    disp("*******Fim do objeto a direita*******");
        ...
        while ((mov == 2) && (( (xg0<xg)) ||(zm_s1>sn(1) || zm_s4>sn(4) || zm_s7>sn(7)) || (zm_s3>sn(3) || zm_s6>sn(6) || zm_s9>sn(9))))    
